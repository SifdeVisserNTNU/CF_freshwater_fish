...
# Read files -------------------------------------------------------------------
RT <- read_delim("Data/RT_species.csv", ",", escape_double = FALSE, trim_ws = TRUE,
...
Area <- read_delim("Data/species_traits.csv", ",", escape_double = FALSE, trim_ws = TRUE,
...
# Save files -------------------------------------------------------------------
saveRDS(Contribution, file = "data\\Contribution\\Contribution.rds")
