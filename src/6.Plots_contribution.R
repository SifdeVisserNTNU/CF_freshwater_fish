...
inset_fig2 <- ggplot(data=Continent_contributions, aes(x=reorder(continent, -Ep_3.2_grid), y=Ep_3.2_grid, fill= '#65156e')) +
...
inset_figS4 <- ggplot(data=Continent_contributions, aes(x=reorder(continent, -Ep_1.5_grid), y=Ep_1.5_grid, fill= '#65156e')) +
  geom_bar(stat="identity") +
  scale_fill_viridis_d(option = "B", begin = 0.2, end = 0.9) +
  scale_y_continuous(limits = c(0, 40),
                     breaks = c(0, 10, 20, 30, 40)) +
...
inset_figS6 <- ggplot(data=Continent_contributions, aes(x=reorder(continent, -Ep_2.0_grid), y=Ep_2.0_grid, fill= '#65156e')) +
  geom_bar(stat="identity") +
  scale_fill_viridis_d(option = "B", begin = 0.2, end = 0.9) +
  scale_y_continuous(limits = c(0, 40),
                     breaks = c(0, 10, 20, 30, 40)) +
